...
if(NOT DEFINED CUDA_SAMPLES_DIR)
    message(
        WARNING
        "CUDA_SAMPLES_DIR variable was not set and it is required by CSR5 benchmark - CSR5 benchmark is disabled."
    )
else()
    ...
    if(result)
        ...
        execute_process(
            ...
            RESULT_VARIABLE result
            WORKING_DIRECTORY
                ${CMAKE_BINARY_DIR}/src/Benchmarks/SpMV/csr5-download
        )
        if(result)
            message(
                ${CMAKE_COMMAND}
            ...
            set(CXX_BENCHMARKS_INCLUDE_DIRS
                ${CXX_BENCHMARKS_INCLUDE_DIRS}
                ${CMAKE_BINARY_DIR}/src/Benchmarks/SpMV/csr5-src
