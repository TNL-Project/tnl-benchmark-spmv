...
__cuda_callable__
Index
BiEllpack< Real, Device, Index >::power( const IndexType number, const IndexType exponent ) const
{
   if( exponent >= 0 ) {
      IndexType result = 1;
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::setDimensions( const IndexType rows, const IndexType columns )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::setCompressedRowLengths( ConstRowCapacitiesTypeView constRowLengths )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::setRowCapacities( ConstRowCapacitiesTypeView constRowLengths )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::getCompressedRowLengths( RowCapacitiesTypeView rowLengths ) const
{
...
template< typename Real, typename Device, typename Index >
Index
BiEllpack< Real, Device, Index >::getRowLength( const IndexType row ) const
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->getRows(), "" );
...
void
BiEllpack< Real, Device, Index >::setLike( const BiEllpack< Real2, Device2, Index2 >& matrix )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::reset()
{
...
template< typename Real2, typename Device2, typename Index2 >
bool
BiEllpack< Real, Device, Index >::operator==( const BiEllpack< Real2, Device2, Index2 >& matrix ) const
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::getRowLengths( RowCapacitiesType& rowLengths ) const
{
   // WHAT IS THIS??!
...
template< typename Real, typename Device, typename Index >
bool
BiEllpack< Real, Device, Index >::setElement( const IndexType row, const IndexType column, const RealType& value )
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->getRows(), "" );
...
__cuda_callable__
bool
BiEllpack< Real, Device, Index >::setElementFast( const IndexType row, const IndexType column, const RealType& value )
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->getRows(), "" );
   TNL_ASSERT_GE( column, 0, "" );
...
template< typename Real, typename Device, typename Index >
bool
BiEllpack< Real, Device, Index >::addElement( const IndexType row,
...
__cuda_callable__
bool
BiEllpack< Real, Device, Index >::addElementFast( const IndexType row,
                                                  const IndexType column,
                                                  const RealType& value,
                                                  const RealType& thisElementMultiplicator )
{
...
template< typename Real, typename Device, typename Index >
bool
BiEllpack< Real, Device, Index >::setRow( const IndexType row,
                                          ...
                                          const IndexType numberOfElements )
{
   ...
   for( IndexType group = 0; ( group < this->getNumberOfGroups( row ) ) && ( thisElementPtr < numberOfElements ); group++ ) {
      for( IndexType i = 0;
           ( i < rowMultiplicator * this->getGroupLength( strip, group ) ) && ( thisElementPtr < numberOfElements );
           i++ )
      {
...
template< typename Real, typename Device, typename Index >
bool
BiEllpack< Real, Device, Index >::addRow( const IndexType row,
                                          const IndexType* columns,
                                          const RealType* values,
                                          const IndexType numberOfElements,
                                          const RealType& thisElementMultiplicator )
...
template< typename Real, typename Device, typename Index >
Real
BiEllpack< Real, Device, Index >::getElement( const IndexType row, const IndexType column ) const
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->getRows(), "" );
   TNL_ASSERT_GE( column, 0, "" );
...
__cuda_callable__
Real
BiEllpack< Real, Device, Index >::getElementFast( const IndexType row, const IndexType column ) const
{
   const IndexType strip = row / this->warpSize;
   const IndexType groupBegin = strip * ( this->logWarpSize + 1 );
   const IndexType rowStripPerm = this->rowPermArray[ row ] - strip * this->warpSize;
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::getRow( const IndexType row, IndexType* columns, RealType* values ) const
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->getRows(), "" );
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::setVirtualRows( const IndexType rows )
{
...
__cuda_callable__
Index
BiEllpack< Real, Device, Index >::getGroupLength( const Index strip, const Index group ) const
{
...
void
BiEllpack< Real, Device, Index >::vectorProduct( const InVector& inVector, OutVector& outVector ) const
{
...
template< typename InVector, typename OutVector >
void
BiEllpack< Real, Device, Index >::vectorProductHost( const InVector& inVector, OutVector& outVector ) const
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::save( File& file ) const
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::load( File& file )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::load( const String& fileName )
{}

template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::print( std::ostream& str ) const
{
   for( IndexType row = 0; row < this->getRows(); row++ ) {
      str << "Row: " << row << " -> ";
      //                str << row << ": ";
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::printValues() const
{
   for( Index i = 0; i < this->values.getSize(); i++ ) {
      if( this->columnIndexes.getElement( i ) != this->getColumns() )
         std::cout << "values.getElement( " << i << " ) = " << this->values.getElement( i ) << "\tcolumnIndexes.getElement( "
                   << i << " ) = " << this->columnIndexes.getElement( i ) << std::endl;
   }
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::performRowBubbleSort( Containers::Vector< Index, Device, Index >& tempRowLengths )
{
...
template< typename Real, typename Device, typename Index >
void
BiEllpack< Real, Device, Index >::computeColumnSizes( Containers::Vector< Index, Device, Index >& tempRowLengths )
{
...
public:
   ...
   static void
   verifyRowLengths( const BiEllpack< Real, Device, Index >& matrix,
   ...
   static void
   vectorProduct( const BiEllpack< Real, Device, Index >& matrix, const InVector& inVector, OutVector& outVector )
   {
   ...
   template< typename Real, typename Index >
   static void
   computeColumnSizes( BiEllpack< Real, Device, Index >& matrix,
                       const typename BiEllpack< Real, Device, Index >::RowCapacitiesType& rowLengths )
   {
      Index numberOfStrips = matrix.virtualRows / matrix.warpSize;
      for( Index strip = 0; strip < numberOfStrips; strip++ ) {
   ...
   template< typename Real, typename Index >
   static void
   performRowBubbleSort( BiEllpack< Real, Device, Index >& matrix,
                         const typename BiEllpack< Real, Device, Index >::RowCapacitiesType& rowLengths
...
__device__
void
BiEllpack< Real, Device, Index >::spmvCuda( const InVector& inVector, OutVector& outVector, int globalIdx ) const
{
...
__global__
void
performRowBubbleSortCuda( BiEllpack< Real, Devices::Cuda, Index >* matrix,
...
__global__
void
computeColumnSizesCuda( BiEllpack< Real, Devices::Cuda, Index >* matrix,
                        const typename BiEllpack< Real, Devices::Cuda, Index >::RowCapacitiesType* rowLengths,
