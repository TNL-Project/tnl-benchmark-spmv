...
template< typename Real, typename Device, typename Index >
std::string
Ellpack< Real, Device, Index >::getSerializationType()
{
   return "Matrices::Ellpack< " + TNL::getType< Real >() + ", [any device], " + getType< Index >() + " >";
}

template< typename Real, typename Device, typename Index >
std::string
Ellpack< Real, Device, Index >::getSerializationTypeVirtual() const
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::setDimensions( const IndexType rows, const IndexType columns )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::setCompressedRowLengths( ConstRowCapacitiesTypeView rowLengths )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::setRowCapacities( ConstRowCapacitiesTypeView rowLengths )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::getCompressedRowLengths( RowCapacitiesTypeView rowLengths ) const
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::setConstantCompressedRowLengths( const IndexType& rowLengths )
{
...
template< typename Real, typename Device, typename Index >
Index
Ellpack< Real, Device, Index >::getRowLength( const IndexType row ) const
{
...
template< typename Real, typename Device, typename Index >
Index
Ellpack< Real, Device, Index >::getNonZeroRowLength( const IndexType row ) const
{
...
void
Ellpack< Real, Device, Index >::setLike( const Ellpack< Real2, Device2, Index2 >& matrix )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::reset()
{
...
template< typename Real2, typename Device2, typename Index2 >
bool
Ellpack< Real, Device, Index >::operator==( const Ellpack< Real2, Device2, Index2 >& matrix ) const
{
...
__cuda_callable__
bool
Ellpack< Real, Device, Index >::setElementFast( const IndexType row, const IndexType column, const Real& value )
{
...
template< typename Real, typename Device, typename Index >
bool
Ellpack< Real, Device, Index >::setElement( const IndexType row, const IndexType column, const Real& value )
{
...
__cuda_callable__
bool
Ellpack< Real, Device, Index >::addElementFast( const IndexType row,
                                                ...
                                                const RealType& thisElementMultiplicator )
{
   ...
   while( i < rowEnd && this->columnIndexes[ i ] < column && this->columnIndexes[ i ] != this->getPaddingIndex() )
      i += step;
   if( i == rowEnd )
      return false;
   ...
   else if( this->columnIndexes[ i ] == this->getPaddingIndex() )  // artificial zero
   {
...
template< typename Real, typename Device, typename Index >
bool
Ellpack< Real, Device, Index >::addElement( const IndexType row,
                                            const IndexType column,
                                            const RealType& value,
                                            const RealType& thisElementMultiplicator )
{
...
__cuda_callable__
bool
Ellpack< Real, Device, Index >::setRowFast( const IndexType row,
...
template< typename Real, typename Device, typename Index >
bool
Ellpack< Real, Device, Index >::setRow( const IndexType row,
                                        const IndexType* columnIndexes,
                                        const RealType* values,
                                        const IndexType elements )
{
...
__cuda_callable__
bool
Ellpack< Real, Device, Index >::addRowFast( const IndexType row,
...
template< typename Real, typename Device, typename Index >
bool
Ellpack< Real, Device, Index >::addRow( const IndexType row,
                                        const IndexType* columns,
                                        const RealType* values,
                                        const IndexType numberOfElements,
                                        const RealType& thisElementMultiplicator )
...
__cuda_callable__
Real
Ellpack< Real, Device, Index >::getElementFast( const IndexType row, const IndexType column ) const
{
   typedef EllpackDeviceDependentCode< DeviceType > DDCType;
...
template< typename Real, typename Device, typename Index >
Real
Ellpack< Real, Device, Index >::getElement( const IndexType row, const IndexType column ) const
{
   typedef EllpackDeviceDependentCode< DeviceType > DDCType;
   IndexType elementPtr = DDCType::getRowBegin( *this, row );
   const IndexType rowEnd = DDCType::getRowEnd( *this, row );
...
__cuda_callable__
void
Ellpack< Real, Device, Index >::getRowFast( const IndexType row, IndexType* columns, RealType* values ) const
{
   // typedef EllpackDeviceDependentCode< DeviceType > DDCType;
...
Ellpack< Real, Device, Index >::rowVectorProduct( const IndexType row, const Vector& vector ) const
{
...
void
Ellpack< Real, Device, Index >::vectorProduct( const InVector& inVector, OutVector& outVector, RealType multiplicator ) const
{
...
void
Ellpack< Real, Device, Index >::addMatrix( const Ellpack< Real2, Device, Index2 >& matrix,
...
template< typename Real2, typename Index2 >
void
Ellpack< Real, Device, Index >::getTransposition( const Ellpack< Real2, Device, Index2 >& matrix,
                                                  const RealType& matrixMultiplicator )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::save( File& file ) const
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::load( File& file )
{
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::save( const String& fileName ) const
{}

template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::load( const String& fileName )
{}

template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::print( std::ostream& str ) const
{
   for( IndexType row = 0; row < this->getRows(); row++ ) {
      str << "Row: " << row << " -> ";
      IndexType i = DeviceDependentCode::getRowBegin( *this, row );
...
template< typename Real, typename Device, typename Index >
void
Ellpack< Real, Device, Index >::allocateElements()
{
   const IndexType numMtxElmnts = this->alignedRows * this->rowLengths;

   if( this->alignedRows != 0 ) {
      TNL_ASSERT_EQ( numMtxElmnts / this->alignedRows,
                     this->rowLengths,
...
public:
   ...
   static void
   vectorProduct( const Ellpack< Real, Device, Index >& matrix,
...
__global__
void
EllpackVectorProductCudaKernel( const Index rows,
                                const Index columns,
                                ...
                                const Index gridIdx )
{
   ...
   Real result( 0.0 );
   Index columnIndex;
   while( el++ < compressedRowLengths && ( columnIndex = columnIndexes[ i ] ) < columns && columnIndex != paddingIndex ) {
