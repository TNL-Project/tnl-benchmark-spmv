...
void
LegacyMatrixReader< Matrix >::readMtxFile( const String& fileName, Matrix& matrix, bool verbose, bool symReader )
{
   std::fstream file;
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::readMtxFile( std::istream& file, Matrix& matrix, bool verbose, bool symReader )
{
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::readMtxFileHostMatrix( std::istream& file,
                                                     Matrix& matrix,
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::verifyMtxFile( std::istream& file, const Matrix& matrix, bool verbose )
{
   bool symmetricMatrix( false );
   IndexType rows, columns;
...
template< typename Matrix >
bool
LegacyMatrixReader< Matrix >::findLineByElement( std::istream& file,
                                                 const IndexType& row,
...
template< typename Matrix >
bool
LegacyMatrixReader< Matrix >::checkMtxHeader( const String& header, bool& symmetric )
{
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::readMtxHeader( std::istream& file,
                                             IndexType& rows,
                                             IndexType& columns,
                                             bool& symmetric,
                                             bool verbose )
   ...
   while( true ) {
      ...
      if( ! headerParsed )
         throw std::runtime_error(
            "Unknown format of the file. We expect line like this: %%MatrixMarket matrix coordinate real general" );
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::computeCompressedRowLengthsFromMtxFile( std::istream& file,
                                                                      ...
                                                                      bool symReader )
{
   ...
   while( std::getline( file, line ) ) {
      ...
      if( ! symReader || ( symReader && row >= column ) )
         rowLengths[ row - 1 ]++;
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::readMatrixElementsFromMtxFile( std::istream& file,
                                                             Matrix& matrix,
                                                             bool symmetricMatrix,
                                                             bool verbose,
                                                             bool symReader )
...
template< typename Matrix >
void
LegacyMatrixReader< Matrix >::parseMtxLineWithElement( const String& line, IndexType& row, IndexType& column, RealType& value )
{
...
public:
   template< typename Matrix >
   static void
   readMtxFile( std::istream& file, Matrix& matrix, bool verbose, bool symReader )
   {
      typename Matrix::RowCapacitiesType rowLengths;
