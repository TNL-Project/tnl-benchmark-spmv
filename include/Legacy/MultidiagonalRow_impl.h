...
__cuda_callable__
MultidiagonalRow< Real, Index >::MultidiagonalRow()
: values( 0 ),
  diagonals( 0 ),
  row( 0 ),
  columns( 0 ),
...
template< typename Real, typename Index >
__cuda_callable__
MultidiagonalRow< Real, Index >::MultidiagonalRow( Real* values,
                                                   Index* diagonals,
...
__cuda_callable__
void
MultidiagonalRow< Real, Index >::bind( Real* values,
                                       Index* diagonals,
                                       const Index maxRowLength,
                                       const Index row,
                                       const Index columns,
...
__cuda_callable__
void
MultidiagonalRow< Real, Index >::setElement( const Index& elementIndex, const Index& column, const Real& value )
{
   ...
   while( row + this->diagonals[ aux ] < column )
      aux++;
