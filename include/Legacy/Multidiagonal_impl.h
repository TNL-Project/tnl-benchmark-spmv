...
template< typename Real, typename Device, typename Index >
std::string
Multidiagonal< Real, Device, Index >::getSerializationType()
{
   return "Matrices::Multidiagonal< " + getType< Real >() + ", " + Device ::getDeviceType() + ", " + TNL::getType< Index >()
        + " >";
}

template< typename Real, typename Device, typename Index >
std::string
Multidiagonal< Real, Device, Index >::getSerializationTypeVirtual() const
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::setDimensions( const IndexType rows, const IndexType columns )
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::setCompressedRowLengths( ConstRowCapacitiesTypeView rowLengths )
{
   /****
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::setRowCapacities( ConstRowCapacitiesTypeView rowLengths )
{
...
template< typename Real, typename Device, typename Index >
Index
Multidiagonal< Real, Device, Index >::getRowLength( const IndexType row ) const
{
...
__cuda_callable__
Index
Multidiagonal< Real, Device, Index >::getRowLengthFast( const IndexType row ) const
{
   IndexType rowLength( 0 );
   for( IndexType i = 0; i < diagonalsShift.getSize(); i++ ) {
...
template< typename Real, typename Device, typename Index >
Index
Multidiagonal< Real, Device, Index >::getMaxRowLength() const
{
...
void
Multidiagonal< Real, Device, Index >::setDiagonals( const Vector& diagonals )
{
...
Multidiagonal< Real, Device, Index >::getDiagonals() const
{
...
void
Multidiagonal< Real, Device, Index >::setLike( const Multidiagonal< Real2, Device2, Index2 >& matrix )
{
...
template< typename Real, typename Device, typename Index >
Index
Multidiagonal< Real, Device, Index >::getNumberOfMatrixElements() const
{
...
template< typename Real, typename Device, typename Index >
Index
Multidiagonal< Real, Device, Index >::getNumberOfNonzeroMatrixElements() const
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::reset()
{
   this->rows = 0;
   this->columns = 0;
   this->values.reset();
...
template< typename Real2, typename Device2, typename Index2 >
bool
Multidiagonal< Real, Device, Index >::operator==( const Multidiagonal< Real2, Device2, Index2 >& matrix ) const
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::setValue( const RealType& v )
{
...
__cuda_callable__
bool
Multidiagonal< Real, Device, Index >::setElementFast( const IndexType row, const IndexType column, const Real& value )
{
   IndexType index;
...
template< typename Real, typename Device, typename Index >
bool
Multidiagonal< Real, Device, Index >::setElement( const IndexType row, const IndexType column, const Real& value )
{
   IndexType index;
...
__cuda_callable__
bool
Multidiagonal< Real, Device, Index >::addElementFast( const IndexType row,
...
template< typename Real, typename Device, typename Index >
bool
Multidiagonal< Real, Device, Index >::addElement( const IndexType row,
                                                  const IndexType column,
                                                  const RealType& value,
                                                  const RealType& thisElementMultiplicator )
{
...
__cuda_callable__
bool
Multidiagonal< Real, Device, Index >::setRowFast( const IndexType row,
...
template< typename Real, typename Device, typename Index >
bool
Multidiagonal< Real, Device, Index >::setRow( const IndexType row,
                                              const Index* columns,
                                              const Real* values,
...
__cuda_callable__
bool
Multidiagonal< Real, Device, Index >::addRowFast( const IndexType row,
                                                  const IndexType* columns,
                                                  const RealType* values,
                                                  const IndexType numberOfElements,
                                                  const RealType& thisElementMultiplicator )
...
template< typename Real, typename Device, typename Index >
bool
Multidiagonal< Real, Device, Index >::addRow( const IndexType row,
                                              const Index* columns,
                                              const Real* values,
                                              const Index numberOfElements,
                                              const RealType& thisElementMultiplicator )
...
__cuda_callable__
Real
Multidiagonal< Real, Device, Index >::getElementFast( const IndexType row, const IndexType column ) const
{
   Index index;
   if( ! this->getElementIndexFast( row, column, index ) )
      return 0.0;
...
template< typename Real, typename Device, typename Index >
Real
Multidiagonal< Real, Device, Index >::getElement( const IndexType row, const IndexType column ) const
{
   Index index;
   if( ! this->getElementIndex( row, column, index ) )
      return 0.0;
...
__cuda_callable__
void
Multidiagonal< Real, Device, Index >::getRowFast( const IndexType row, IndexType* columns, RealType* values ) const
{
   IndexType pointer( 0 );
   for( IndexType i = 0; i < diagonalsShift.getSize(); i++ ) {
      const IndexType column = row + diagonalsShift[ i ];
...
Multidiagonal< Real, Device, Index >::getRow( const IndexType rowIndex )
{
...
Multidiagonal< Real, Device, Index >::getRow( const IndexType rowIndex ) const
{
   IndexType firstRowElement( 0 );
   while( rowIndex + this->diagonalsShift[ firstRowElement ] < 0 )
      firstRowElement++;
...
Multidiagonal< Real, Device, Index >::rowVectorProduct( const IndexType row, const Vector& vector ) const
{
   typedef MultidiagonalDeviceDependentCode< Device > DDCType;
   Real result = 0.0;
   for( Index i = 0; i < this->diagonalsShift.getSize(); i++ ) {
      const Index column = row + this->diagonalsShift[ i ];
      if( column >= 0 && column < this->getColumns() )
         result += this->values[ DDCType::getElementIndex( this->getRows(), this->diagonalsShift.getSize(), row, i ) ]
                 * vector[ column ];
   }
   return result;
}
...
void
Multidiagonal< Real, Device, Index >::vectorProduct( const InVector& inVector, OutVector& outVector ) const
{
...
void
Multidiagonal< Real, Device, Index >::addMatrix( const Multidiagonal< Real2, Device, Index2 >& matrix,
...
template< typename Real2, typename Index2 >
void
Multidiagonal< Real, Device, Index >::getTransposition( const Multidiagonal< Real2, Device, Index2 >& matrix,
                                                        const RealType& matrixMultiplicator )
{
   ...
   this->setDimensions( matrix.getColumns(), matrix.getRows() );
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::save( File& file ) const
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::load( File& file )
{
...
template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::save( const String& fileName ) const
{}

template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::load( const String& fileName )
{}

template< typename Real, typename Device, typename Index >
void
Multidiagonal< Real, Device, Index >::print( std::ostream& str ) const
{
...
template< typename Real, typename Device, typename Index >
bool
Multidiagonal< Real, Device, Index >::getElementIndex( const IndexType row, const IndexType column, Index& index ) const
{
   TNL_ASSERT_GE( row, 0, "" );
...
__cuda_callable__
bool
Multidiagonal< Real, Device, Index >::getElementIndexFast( const IndexType row, const IndexType column, Index& index ) const
{
   TNL_ASSERT_GE( row, 0, "" );
   TNL_ASSERT_LT( row, this->rows, "" );
   TNL_ASSERT_GE( column, 0, "" );
...
public:
   ...
   __cuda_callable__
   static Index
   getElementIndex( const Index rows, const Index diagonals, const Index row, const Index diagonal )
   {
   ...
   static void
   vectorProduct( const Multidiagonal< Real, Device, Index >& matrix, const InVector& inVector, OutVector& outVector )
   {
#ifdef HAVE_OPENMP
