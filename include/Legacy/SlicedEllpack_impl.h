...
{
   return "Matrices::SlicedEllpack< " + TNL::getType< Real >() + ", [any_device], " + TNL::getType< Index >() + " >";
}

template< typename Real, typename Device, typename Index, int SliceSize >
std::string
SlicedEllpack< Real, Device, Index, SliceSize >::getSerializationTypeVirtual() const
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::setDimensions( const IndexType rows, const IndexType columns )
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::setCompressedRowLengths( ConstRowCapacitiesTypeView rowLengths )
{
   ...
   const IndexType slices = roundUpDivision( this->rows, static_cast< IndexType >( SliceSize ) );
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::setRowCapacities( ConstRowCapacitiesTypeView rowLengths )
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::getCompressedRowLengths( RowCapacitiesTypeView rowLengths ) const
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
Index
SlicedEllpack< Real, Device, Index, SliceSize >::getRowLength( const IndexType row ) const
{
...
__cuda_callable__
Index
SlicedEllpack< Real, Device, Index, SliceSize >::getRowLengthFast( const IndexType row ) const
{
   const IndexType slice = row / SliceSize;
...
template< typename Real, typename Device, typename Index, int SliceSize >
Index
SlicedEllpack< Real, Device, Index, SliceSize >::getNonZeroRowLength( const IndexType row ) const
{
...
void
SlicedEllpack< Real, Device, Index, SliceSize >::setLike( const SlicedEllpack< Real2, Device2, Index2, SliceSize >& matrix )
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::reset()
{
...
template< typename Real2, typename Device2, typename Index2 >
bool
SlicedEllpack< Real, Device, Index, SliceSize >::operator==( const SlicedEllpack< Real2, Device2, Index2 >& matrix ) const
{
...
__cuda_callable__
bool
SlicedEllpack< Real, Device, Index, SliceSize >::setElementFast( const IndexType row,
...
template< typename Real, typename Device, typename Index, int SliceSize >
bool
SlicedEllpack< Real, Device, Index, SliceSize >::setElement( const IndexType row, const IndexType column, const Real& value )
{
...
__cuda_callable__
bool
SlicedEllpack< Real, Device, Index, SliceSize >::addElementFast( const IndexType row,
                                                                 const IndexType column,
...
template< typename Real, typename Device, typename Index, int SliceSize >
bool
SlicedEllpack< Real, Device, Index, SliceSize >::addElement( const IndexType row,
                                                             const IndexType column,
                                                             const RealType& value,
                                                             const RealType& thisElementMultiplicator )
{
...
__cuda_callable__
bool
SlicedEllpack< Real, Device, Index, SliceSize >::setRowFast( const IndexType row,
...
template< typename Real, typename Device, typename Index, int SliceSize >
bool
SlicedEllpack< Real, Device, Index, SliceSize >::setRow( const IndexType row,
                                                         const IndexType* columnIndexes,
                                                         const RealType* values,
                                                         const IndexType elements )
{
...
__cuda_callable__
bool
SlicedEllpack< Real, Device, Index, SliceSize >::addRowFast( const IndexType row,
...
template< typename Real, typename Device, typename Index, int SliceSize >
bool
SlicedEllpack< Real, Device, Index, SliceSize >::addRow( const IndexType row,
                                                         const IndexType* columns,
                                                         const RealType* values,
                                                         const IndexType numberOfElements,
                                                         const RealType& thisElementMultiplicator )
...
__cuda_callable__
Real
SlicedEllpack< Real, Device, Index, SliceSize >::getElementFast( const IndexType row, const IndexType column ) const
{
   Index elementPtr, rowEnd, step;
   DeviceDependentCode::initRowTraverseFast( *this, row, elementPtr, rowEnd, step );
...
template< typename Real, typename Device, typename Index, int SliceSize >
Real
SlicedEllpack< Real, Device, Index, SliceSize >::getElement( const IndexType row, const IndexType column ) const
{
   Index elementPtr, rowEnd, step;
   DeviceDependentCode::initRowTraverse( *this, row, elementPtr, rowEnd, step );
...
__cuda_callable__
void
SlicedEllpack< Real, Device, Index, SliceSize >::getRowFast( const IndexType row, IndexType* columns, RealType* values ) const
{
...
SlicedEllpack< Real, Device, Index, SliceSize >::getRow( const IndexType rowIndex )
{
   ...
   return MatrixRow(
      &this->columnIndexes[ rowBegin ], &this->values[ rowBegin ], this->sliceCompressedRowLengths[ slice ], step );
}

template< typename Real, typename Device, typename Index, int SliceSize >
__cuda_callable__
typename SlicedEllpack< Real, Device, Index, SliceSize >::ConstMatrixRow
SlicedEllpack< Real, Device, Index, SliceSize >::getRow( const IndexType rowIndex ) const
{
   Index rowBegin, rowEnd, step;
   DeviceDependentCode::initRowTraverseFast( *this, rowIndex, rowBegin, rowEnd, step );
   const IndexType slice = rowIndex / SliceSize;
...
SlicedEllpack< Real, Device, Index, SliceSize >::rowVectorProduct( const IndexType row, const Vector& vector ) const
{
   Real result = 0.0;
   Index elementPtr, rowEnd, step;
   DeviceDependentCode::initRowTraverseFast( *this, row, elementPtr, rowEnd, step );
...
void
SlicedEllpack< Real, Device, Index, SliceSize >::vectorProduct( const InVector& inVector,
                                                                OutVector& outVector,
...
void
SlicedEllpack< Real, Device, Index, SliceSize >::addMatrix( const SlicedEllpack< Real2, Device, Index2 >& matrix,
...
template< typename Real2, typename Index2 >
void
SlicedEllpack< Real, Device, Index, SliceSize >::getTransposition( const SlicedEllpack< Real2, Device, Index2 >& matrix,
                                                                   const RealType& matrixMultiplicator )
{
...
SlicedEllpack< Real, Device, Index, SliceSize >::operator=( const SlicedEllpack< Real2, Device2, Index2, SliceSize >& matrix )
{
   ...
   if( std::is_same< Device, Devices::Cuda >::value ) {
      ...
      typename ColumnIndexesVector::template Self< typename ColumnIndexesVector::ValueType, Devices::Sequential >
         tmpColumnIndexes;
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::save( File& file ) const
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::load( File& file )
{
...
template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::save( const String& fileName ) const
{}

template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::load( const String& fileName )
{}

template< typename Real, typename Device, typename Index, int SliceSize >
void
SlicedEllpack< Real, Device, Index, SliceSize >::print( std::ostream& str ) const
{
   if( ! std::is_same< Device, Devices::Cuda >::value ) {
      for( IndexType row = 0; row < this->getRows(); row++ ) {
         str << "Row: " << row << " -> ";
         const IndexType sliceIdx = row / SliceSize;
         const IndexType rowLength = this->sliceCompressedRowLengths.getElement( sliceIdx );
         IndexType elementPtr = this->slicePointers.getElement( sliceIdx ) + rowLength * ( row - sliceIdx * SliceSize );
...
__device__
void
SlicedEllpack< Real, Device, Index, SliceSize >::computeMaximalRowLengthInSlicesCuda( ConstRowCapacitiesTypeView rowLengths,
...
public:
   ...
   __cuda_callable__
   static void
   initRowTraverseFast( const SlicedEllpack< Real, Device, Index, SliceSize >& matrix,
                        const Index row,
                        Index& rowBegin,
                        Index& rowEnd,
                        Index& step )
   ...
   template< typename Real, typename Index, int SliceSize >
   static bool
   computeMaximalRowLengthInSlices( SlicedEllpack< Real, Device, Index, SliceSize >& matrix,
   ...
   template< typename Real, typename Index, typename InVector, typename OutVector, int SliceSize >
   static void
...
__global__
void
SlicedEllpack_computeMaximalRowLengthInSlices_CudaKernel(
...
__global__
void
SlicedEllpackVectorProductCudaKernel( const Index rows,
                                      const Index columns,
                                      ...
                                      const Index gridIdx )
{
   ...
   Real result( 0.0 );
   Index columnIndex;
   while( i < rowEnd && ( columnIndex = columnIndexes[ i ] ) < columns && columnIndex < paddingIndex ) {
...
public:
                                    ...
                                    typename SlicedEllpack< Real, Device, Index >::ConstRowCapacitiesTypeView rowLengths )
   {
      ...
      const Index numberOfSlices = roundUpDivision( matrix.getRows(), static_cast< Index >( SliceSize ) );
      dim3 cudaBlockSize( 256 ), cudaGridSize( Backend::getMaxGridXSize() );
      const Index cudaBlocks = roundUpDivision( numberOfSlices, static_cast< Index >( cudaBlockSize.x ) );
